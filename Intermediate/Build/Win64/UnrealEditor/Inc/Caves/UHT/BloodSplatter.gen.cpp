...
struct Z_Construct_UFunction_ABloodSplatter_InitParams_Statics
{
	...
	static const UECodeGen_Private::FIntPropertyParams NewProp__num_frames;
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_ABloodSplatter_InitParams_Statics::NewProp__num_frames = { "_num_frames", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(BloodSplatter_eventInitParams_Parms, _num_frames), METADATA_PARAMS(0, nullptr) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ABloodSplatter_InitParams_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ABloodSplatter_InitParams_Statics::NewProp__num_frames,
...
DEFINE_FUNCTION(ABloodSplatter::execInitParams)
{
	...
	P_GET_PROPERTY(FIntProperty,Z_Param__num_frames);
...
struct Z_Construct_UClass_ABloodSplatter_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_num_frames_MetaData[] = {
		{ "Category", "Initialization" },
		{ "ModuleRelativePath", "Public/BloodSplatter.h" },
	};
	...
	static const UECodeGen_Private::FIntPropertyParams NewProp_num_frames;
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ABloodSplatter_Statics::NewProp_num_frames = { "num_frames", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ABloodSplatter, num_frames), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_num_frames_MetaData), NewProp_num_frames_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABloodSplatter_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABloodSplatter_Statics::NewProp_num_frames,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_becca_source_repos_Caves_Source_Caves_Public_BloodSplatter_h_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_becca_source_repos_Caves_Source_Caves_Public_BloodSplatter_h_3992409527(TEXT("/Script/Caves"),
	Z_CompiledInDeferFile_FID_Users_becca_source_repos_Caves_Source_Caves_Public_BloodSplatter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_becca_source_repos_Caves_Source_Caves_Public_BloodSplatter_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
