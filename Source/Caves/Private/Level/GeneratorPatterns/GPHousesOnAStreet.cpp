...
void UGPHousesOnAStreet::GenerateLevel() {
	...
	for (int i = 0; i < house_locations.Num(); i++) {
		...
		parent->SetTile(house_location[0], house_location[1], MaterialType::shingles, 8, false);
		parent->SetTile(other_house_location[0], other_house_location[1], MaterialType::shingles, 8, false);
